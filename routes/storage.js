          ...
          models.FoodprintHarvest.findAll({
            ...
            .then(async harvest_rows => {
              ...
              res.render('storagelogbook', {
                page_title: 'MercTest - Storage Logbook',
                data: rows,
  ...
  function (req, res) {
    models.FoodprintStorage.findAll({
      ...
      .then(rows => {
        ...
        const pdfFilename = `MercTest_Storage_${username}_${moment(new Date()).format(
          'YYYY-MM-DD'
        )}`;
    ...
    models.User.findOne({
      ...
      .then(user => {
        ...
        models.FoodprintStorage.findAll({
          ...
          .then(rows => {
            const pdfFilename = `MercTest_Storage_${phoneNumber}`;
            const pdffileextension = '.pdf';
