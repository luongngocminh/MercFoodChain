...
router.get('/login', function (req, res) {
  if (req.user) {
    ...
    res.render('login', { title: 'Merc - User Login', user: req.user, page_name: 'login' });
  }
});
...
router.get('/register/:message?', function (req, res) {
  req.params.message
    ? res.render('message', {
        title: 'MercTest - User Registration',
        user: req.user,
        page_name: 'message',
        message:
          'Your registration has been submitted and is currently under review by the MercTest Team! You will be notified of status updates via the email you provided.',
      })
    : res.render('register', {
        title: 'MercTest - User Registration',
        user: req.user,
...
router.post('/register', function (req, res) {
  //TODO - Log registration to table and send email to MercTest Admin
